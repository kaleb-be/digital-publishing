  ...
  <AlertDialogPortal>
    ...
    <AlertDialogPrimitive.Content
      ...
      className={cn(
        ...
        " border border-zinc-200 bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in" +
        ...
        " data-[state=open]:slide-in-from-top-[48%] rounded-lg dark:border-zinc-800 dark:bg-zinc-950",
        className
      )}
      {...props}
    />
